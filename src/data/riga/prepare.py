...
def process_main_ds(nnunet_rawraw_dirs, dataset_out_dir):
    ...
    dataset_json_content = {
        "name": "RIGA_consensus_annotatormajority",
        "description": "RIGA dataset with consensus annotator majority labels",
        "file_ending": ".tif",
        "channel_names": {
            "0": "R",
            "1": "G",
...
def main(nnunet_rawraw_dirs, nnunet_raw_outdir, dataset_id):
    ...
    dataset_out_dir = nnunet_raw_outdir / f"Dataset{dataset_id}_RIGA_consensus_annotatormajority"
...
if __name__=="__main__":
    nnunet_rawraw_dir1 = Path("/home/m391k/E132-Projekte/Projects/2024_Bujotzek_Noisy-Seg-Label-Benchi/data/RIGA/nnUNet_raw/Dataset300_RIGA-BinRushed_annotator_majority")
    nnunet_rawraw_dir2 = Path("/home/m391k/E132-Projekte/Projects/2024_Bujotzek_Noisy-Seg-Label-Benchi/data/RIGA/nnUNet_raw/Dataset302_RIGA-MESSIDOR_annotator_majority")
    nnunet_rawraw_dir3_ood = Path("/home/m391k/E132-Projekte/Projects/2024_Bujotzek_Noisy-Seg-Label-Benchi/data/RIGA/nnUNet_raw/Dataset301_RIGA-Magrabia_annotator_majority")
    nnunet_rawraw_dirs = {
        "main_ds": [nnunet_rawraw_dir1, nnunet_rawraw_dir2],
        "ood_ds": [nnunet_rawraw_dir3_ood]
    }

    nnunet_raw_outdir = Path("/home/m391k/E132-Projekte/Projects/2026_Kirscher_LostInFolds/data/RIGA")
    dataset_id = "002"
